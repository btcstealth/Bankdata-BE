...
public class AccountResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public void depositFunds(@PathParam("accountNumber") int accountNumber, @PathParam("funds") double funds) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public void transferFunds(@PathParam("senderAccountNumber") @NotNull int senderAccountNumber, @PathParam("receiverAccountNumber") @NotNull int receiverAccountNumber, @PathParam("funds") @NotNull double funds) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public double getBalance(@PathParam("accountNumber") int accountNumber) {
        return 0.0;
    }
